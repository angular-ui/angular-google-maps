...
angular.module('angularGoogleMapsApp', ['ngAnimate', 'ngSanitize', 'uiGmapgoogle-maps', 'hljs', 'semverSort', 'ui.router']);
...
angular.module('angularGoogleMapsApp')
  ...
  function ($stateProvider, $urlRouterProvider, $locationProvider, $logProvider, $githubProvider, analyticsProvider, $sceDelegateProvider, hljsServiceProvider) {
    ...
    $githubProvider.username('angular-ui')
...
angular.module('angularGoogleMapsApp')
  .directive('rel', ['$log', function ($log) {
    return {
      restrict: 'A',
...
angular.module('angularGoogleMapsApp')
  .directive('googleApi',['$log', function ($log) {
    return {
      restrict: 'A',
      link: function postLink(scope, element, attrs) {
